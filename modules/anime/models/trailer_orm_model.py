...
class Trailer(Base):
    ...
    url: Mapped[Optional[str]] = mapped_column(String(100), server_default=None)
    embed_url: Mapped[Optional[str]] = mapped_column(String(100), server_default=None)
    youtube_id: Mapped[Optional[str]] = mapped_column(String(100), server_default=None)
